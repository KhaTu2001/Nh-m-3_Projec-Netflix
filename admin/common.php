	...
	<nav class="container-fluid navbar_header" role="navigation">
        ...
        <g id="netflix-logo">
          ...
          ></path>
			...
			<ul id="active" class="navbar_option-left">
				<li>
					<a href="addFilm.php">
			...
			<ul class="">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						<li>
							<a class ="dropdown-item" href="<?php echo "editUser.php?id=".$rowAd["ID"]?>"> <i class="fa fa-user"></i> Profile</a>
						</li>
						<li>
							<form method="post" action="">
								<a class ="dropdown-item"> <button id="logout" name="log_out" style=""> 
