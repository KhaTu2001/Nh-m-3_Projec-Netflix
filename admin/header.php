	...
	<nav class="container-fluid navbar_header" role="navigation">
		...
		<!-- <div class="dropdown">
			<button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
					<i style="margin-right:4px;" class="fas fa-user"></i>
					admin
			</button>
				<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
					<li><a class="dropdown-item" href="#">My profile<i style="margin-left:12px;"class="far fa-address-card"></i></a></li>
					<li><a class="dropdown-item" href="#">Sign out<i style="margin-left:12px;" class="fas fa-sign-out-alt"></i></a></li>
