...
<nav class="container-fluid navbar_header" role="navigation">
        ...
        <div class=" container admin-list">
            <div class="container" style="margin-top: 30px;padding:20px">
                <h5 class="text-center " style="font-size: 20px;">List Admin</h5>
                <div class="container">
                        <a class="btn btn-primary mb-3" href="./addadmin.php" style="width:70px">Add</a>
                </div>
                    ...
                    <div class="table_box">
                        ...
                        <!-- get from database -->
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM user where usertype = '99'";
                            ...
                            ?>
                                        <tr style="color:#fff;">
                                            ...
                                            <td>
                                                <a href="deleteadmin.php?id=<?php echo $row['ID']; ?>"><i class="bi bi-trash" style="font-size: 20px;color:#fff"></i></a>
                                            </td>
