        ...
        <div class="container">
            <div class="row align-items-center reverse">
                <div class="advertise_part1 col-lg-6">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.netflix.mediaclient">Get the app<i
                            class="fas fa-chevron-right"></i></a>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div id="collapsetwo" class="collapse" data-bs-parent="#accordion">
                                <div class="card-body">
                                    ...
                                    for one fixed monthly fee. Plans range from 70,000 ₫ to 260,000 ₫ a month. No extra
                                    costs, no contracts.
                                </div>
                            </div>
                        </div>
