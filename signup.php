...
<body style="background-image: url(assets/img/slide-banner.jpg);height: 100vh;">
  ...
  <nav id="header" class=" navbar navbar-light p-0">
    <div class="container-fluid px-5 head">
      <a href="index.php" class="navbar-brand"> <svg viewBox="0 0 111 30" class="header_navbar--logo" focusable="false">
          <g id="netflix-logo">
            <path
  ...
  <div class="signup_form container">
    <form class="mx-1 mx-md-4 " method="POST" action="./src/signup_process.php" name="Signup">
        ...
        <div class="col-md-6 col-sm-12">
          <div class="d-flex flex-row align-items-center mb-3">
            ...
            <div class="form-outline flex-fill mb-0">
              ...
              <input type="text" id="userName" name="userName" class="form-control formuser" placeholder="User name"
                required>
              ...
              <div class="form-outline flex-fill">
                ...
                <div class=" email_check">
                  <input type="email" id="inputEmail" name="txtEmail" class="form-control" placeholder="Email address"
                    required>
                  <div class="icon">
                    <i class="bi bi-check2" id="true1"></i>
                    <i class="bi bi-x-lg" id="false1"></i>
                  </div>
                </div>
              ...
              <div class="form-outline flex-fill mb-5">
                ...
                <div class=" email_check">
                  <input type="password" id="inputPassword1" name="txtPass1" class="form-control" placeholder="Password"
                    required>
                  <div class="icon">
                    <i class="bi bi-check2" id="true2"></i>
                    <i class="bi bi-x-lg" id="false2"></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="mb-3 form_signup">
            <h5 style="font-size: 20px;">Already have an account?</h5>
        ...
        <div class=" col-md-6 col-sm-12">
          <div class="d-flex flex-row align-items-center mb-3">
            <div class="form-outline flex-fill mb-0">
              ...
              <input type="text" id="firstName" name="FullName" class="form-control formuser" placeholder="Full name"
                required>
            ...
            <div class="form-outline flex-fill mb-0">
              ...
              <div class=" email_check">
                <input type="text" id="inputPhone" name="txtphone" class="form-control" placeholder="Phone number"
                  required>
                <div class="icon">
                  <i class="bi bi-check2" id="true3"></i>
                  <i class="bi bi-x-lg" id="false3"></i>
                </div>
              </div>
          ...
          <div class="d-flex flex-row align-items-center mb-2">
            ...
            <div class="form-outline flex-fill ">
              ...
              <div class=" email_check">
                ...
                <div class="icon">
                  <i class="bi bi-check2" id="true4"></i>
                  <i class="bi bi-x-lg" id="false4"></i>
                </div>
              </div>
      ...
      <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
        <button type="submit" class="btn btn-primary mb-3" id="btnSubmit1" name="btn_submit1" style="width:400px">Sign
          in</button>
      </div>
  ...
  <div class="login_footer">
    <div class="container">
      <a href="./footer/contactus.php" class="question-contact my-4" style="margin-left: 32px;">Questions? Contact
        us.</a>
      <div class="row">
        ...
        <div class="col-md-3 col-6 my-4">
          <ul>
            <li><a href="./footer/termsofuse.php">Terms of Us</a></li>
          </ul>
        </div>
        <div class="col-md-3 col-6 my-4">
          <ul>
